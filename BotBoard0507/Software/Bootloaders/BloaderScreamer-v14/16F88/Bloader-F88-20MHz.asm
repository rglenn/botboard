...
nate        EQU   0x26
  ...
  ; FILE D:\Pics\code\16F88\Bloader\Bloader-F88-20MHz.c
			;/*
			;    1-4-04
...
; 0x0F00 P1  159 word(s)  7 % : bloader
; 0x0FB3 P1   56 word(s)  2 % : onboard_program_write
; 0x0FEB P1    6 word(s)  0 % : putc
; 0x0FF1 P1    4 word(s)  0 % : getc
; 0x0F9F P1   20 word(s)  0 % : onboard_program_erase

; RAM usage: 27 bytes (8 local), 341 bytes free
; Maximum call level: 2
;  Codepage 0 has   71 word(s) :   3 %
;  Codepage 1 has  245 word(s) :  11 %
; Total of 316 code words (7 %)
