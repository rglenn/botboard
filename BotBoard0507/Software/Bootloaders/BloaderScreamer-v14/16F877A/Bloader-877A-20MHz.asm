...
nate        EQU   0x26
  ...
  ; FILE D:\Pics\code\16F877A\Bloader\Bloader-877A-20MHz.c
			;/*
			;    1-4-04
			;    Copyright Spark Fun Electronics© 2004
			;    
			;    Boot loader for the 16F877A
			;    
			...
			;
			;#include "d:\Pics\c\16F877A.h"  //Device definitions
			;
...
; 0x0004 P0   77 word(s)  3 % : main

; 0x1F40 P3  121 word(s)  5 % : bloader
; 0x1FB9 P3   55 word(s)  2 % : onboard_program_write
; 0x1FF0 P3    6 word(s)  0 % : putc
; 0x1FF6 P3    4 word(s)  0 % : getc

; RAM usage: 26 bytes (7 local), 342 bytes free
; Maximum call level: 2
;  Codepage 0 has   81 word(s) :   3 %
;  Codepage 1 has    0 word(s) :   0 %
;  Codepage 2 has    0 word(s) :   0 %
;  Codepage 3 has  186 word(s) :   9 %
; Total of 267 code words (3 %)
