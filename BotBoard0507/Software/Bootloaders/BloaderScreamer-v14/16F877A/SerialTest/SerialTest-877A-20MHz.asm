...
ci          EQU   0x31
  ...
  ; FILE D:\Pics\code\16F877A\Serial Test\SerialTest-877A-20MHz.c
			;/*
			;    5-11-04
...
; 0x0026 P0   14 word(s)  0 % : enable_uart_TX
; 0x0034 P0   15 word(s)  0 % : enable_uart_RX
; 0x0043 P0    6 word(s)  0 % : putc
; 0x0049 P0    4 word(s)  0 % : getc
; 0x004D P0   20 word(s)  0 % : bin2Hex
; 0x0061 P0  185 word(s)  9 % : printf
; 0x0004 P0   34 word(s)  1 % : _const1
; 0x011A P0   26 word(s)  1 % : main

; RAM usage: 22 bytes (22 local), 346 bytes free
; Maximum call level: 2
;  Codepage 0 has  305 word(s) :  14 %
;  Codepage 1 has    0 word(s) :   0 %
;  Codepage 2 has    0 word(s) :   0 %
;  Codepage 3 has    0 word(s) :   0 %
; Total of 305 code words (3 %)
