...
; 0x0004 P0   72 word(s)  3 % : main

; 0x0F40 P1  125 word(s)  6 % : bloader
; 0x0FBD P1   53 word(s)  2 % : onboard_program_write
; 0x0FF2 P1    6 word(s)  0 % : putc
; 0x0FF8 P1    4 word(s)  0 % : getc

; RAM usage: 26 bytes (7 local), 166 bytes free
; Maximum call level: 2
;  Codepage 0 has   76 word(s) :   3 %
;  Codepage 1 has  188 word(s) :   9 %
; Total of 264 code words (6 %)
